...
<!-- Flot plugins -->
<script src="<?php echo base_url(); ?>theme/production/js/flot/jquery.flot.orderBars.js"></script>
<script src="<?php echo base_url(); ?>theme/production/js/flot/date.js"></script>
<script src="<?php echo base_url(); ?>theme/production/js/flot/jquery.flot.spline.js"></script>
<script src="<?php echo base_url(); ?>theme/production/js/flot/curvedLines.js"></script>
<!-- jVectorMap -->
<!--script src="<?php echo base_url(); ?>theme/production/js/maps/jquery-jvectormap-2.0.3.min.js"></script-->
<!-- bootstrap-daterangepicker -->
<!--script src="<?php echo base_url(); ?>theme/production/js/moment/moment.min.js"></script-->
<script src="<?php echo base_url(); ?>theme/production/js/datepicker/daterangepicker.js"></script>
...
<!-- jVectorMap -->
<script src="<?php echo base_url(); ?>theme/production/js/maps/gdp-data.js"></script>
<!-- /jVectorMap -->
